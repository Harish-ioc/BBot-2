...
url = "https://741b-103-207-171-178.ngrok-free.app/api/generate"


new="is there a possibility for the B-bot to work on carnival"
...
Answer the following user query based on the given information: 
{new}
"""
data = {
    "model": "mistral",
